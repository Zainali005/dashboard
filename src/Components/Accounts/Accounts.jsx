      ...
      <div className="bank">
        ...
        <div className="bank-details">
            ...
            <div className="bank-series" key={index}>
              <div className="row">
                ...
                <div className="col-md-7">
                  ...
                  >
                    <div className="col-md-11 bank-name">{account.bankName}</div>
          ...
          <div className="bank-series">
            <div className="row">
              <div className="col-md-2 bank-icon">
                <VscDiffAdded />
              </div>
              <div className="col-md-9">
                <div className="row">
                  <a onClick={handleTogglePopup}>Add Account</a>
                  {showPopup && <AddAccountPopup onAddAccount={handleAddAccount} onClose={handleClose} />}
                </div>
              </div>
            </div>
          </div>
